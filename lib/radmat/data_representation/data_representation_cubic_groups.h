...
namespace radmat
{
  ...
  struct A1Rep_t : public CubicRepRest_t<Oh,A1> { virtual ~A1Rep_t() {} };
  struct A2Rep_t : public CubicRepRest_t<Oh,A2> { virtual ~A2Rep_t() {} };
  struct T1Rep_t : public CubicRepRest_t<Oh,T1> { virtual ~T1Rep_t() {} };
  struct T2Rep_t : public CubicRepRest_t<Oh,T2> { virtual ~T2Rep_t() {} };
  struct ERep_t  : public CubicRepRest_t<Oh,E > { virtual ~ERep_t()  {} };
  ...
  // D4 
  struct H0D4A1Rep_t : public CubicRepFlight_t<H0,D4,A1> { virtual ~H0D4A1Rep_t() {} };
  struct H0D4A2Rep_t : public CubicRepFlight_t<H0,D4,A2> { virtual ~H0D4A2Rep_t() {} };
  struct H1D4E2Rep_t : public CubicRepFlight_t<H1,D4,E2> { virtual ~H1D4E2Rep_t() {} };
  struct H2D4B1Rep_t : public CubicRepFlight_t<H2,D4,B1> { virtual ~H2D4B1Rep_t() {} };
  struct H2D4B2Rep_t : public CubicRepFlight_t<H2,D4,B2> { virtual ~H2D4B2Rep_t() {} };
  struct H3D4E2Rep_t : public CubicRepFlight_t<H3,D4,E2> { virtual ~H3D4E2Rep_t() {} };
  struct H4D4A1Rep_t : public CubicRepFlight_t<H4,D4,A1> { virtual ~H4D4A1Rep_t() {} };
  struct H4D4A2Rep_t : public CubicRepFlight_t<H4,D4,A2> { virtual ~H4D4A2Rep_t() {} };


  // D2 
  struct H0D2A1Rep_t : public CubicRepFlight_t<H0,D2,A1> { virtual ~H0D2A1Rep_t() {} };
  struct H0D2A2Rep_t : public CubicRepFlight_t<H0,D2,A2> { virtual ~H0D2A2Rep_t() {} };
  struct H1D2B1Rep_t : public CubicRepFlight_t<H1,D2,B1> { virtual ~H1D2B1Rep_t() {} };
  struct H1D2B2Rep_t : public CubicRepFlight_t<H1,D2,B2> { virtual ~H1D2B2Rep_t() {} };
  struct H2D2A1Rep_t : public CubicRepFlight_t<H2,D2,A1> { virtual ~H2D2A1Rep_t() {} };
  struct H2D2A2Rep_t : public CubicRepFlight_t<H2,D2,A2> { virtual ~H2D2A2Rep_t() {} };
  struct H3D2B1Rep_t : public CubicRepFlight_t<H3,D2,B1> { virtual ~H3D2B1Rep_t() {} };
  struct H3D2B2Rep_t : public CubicRepFlight_t<H3,D2,B2> { virtual ~H3D2B2Rep_t() {} };
  struct H4D2A1Rep_t : public CubicRepFlight_t<H4,D2,A1> { virtual ~H4D2A1Rep_t() {} };
  struct H4D2A2Rep_t : public CubicRepFlight_t<H4,D2,A2> { virtual ~H4D2A2Rep_t() {} };


  // D3 
  struct H0D3A1Rep_t : public CubicRepFlight_t<H0,D3,A1> { virtual ~H0D3A1Rep_t() {} };
  struct H0D3A2Rep_t : public CubicRepFlight_t<H0,D3,A2> { virtual ~H0D3A2Rep_t() {} };
  struct H1D3E2Rep_t : public CubicRepFlight_t<H1,D3,E2> { virtual ~H1D3E2Rep_t() {} };
  struct H2D3E2Rep_t : public CubicRepFlight_t<H2,D3,E2> { virtual ~H2D3E2Rep_t() {} };
  struct H3D3A1Rep_t : public CubicRepFlight_t<H3,D3,A1> { virtual ~H3D3A1Rep_t() {} };
  struct H3D3A2Rep_t : public CubicRepFlight_t<H3,D3,A2> { virtual ~H3D3A2Rep_t() {} };
  struct H4D3E2Rep_t : public CubicRepFlight_t<H4,D3,E2> { virtual ~H4D3E2Rep_t() {} };
