#ifndef TEST_NARRAY_H_H_GUARD
#define TEST_NARRAY_H_H_GUARD
...
namespace radmat
{
    ...
    int test_NARRAY(void)
    {
        ...
        narray_t<T, 2> ctrack1, ctrack2, ctrack3;
        ...
        pp4 = p4;
        narray_t<T, 6> p6 = contract(pp4, p4, 2, 1);
        ...
        narray_t<T, 3> o3base, omul, odiv, oadd, osub, ominus;
        ...
        narray_t<T, 3> bar;
        bar = contract_M(o3base, metric, 1);
        ...
        std::cout << "All " << Stringify<T>() << " narray tests successfull" << std::endl;
